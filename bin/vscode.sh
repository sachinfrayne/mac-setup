...
tee "${HOME}/Library/Application Support/Code/User/settings.json" <<'EOF' >/dev/null
{
  "cSpell.customDictionaries": {
    "custom-dictionary-user": {
      ...
      "path": "~/Library/Application Support/Code/User/custom-dictionary-user.txt",
      "addWords": true,
      "scope": "user"
    }
  },
...
tee "${HOME}/Library/Application Support/Code/User/custom-dictionary-user.txt" <<'EOF' >/dev/null
docstrings
elasticsearch
kibana
EOF
